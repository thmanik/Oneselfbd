...
const ProductTable = ({
  ...
  const renderTableHeader = () => (
    <TableRow className="bg-gray-200 font-bold text-xs md:text-base">
      ...
      <TableCell className="px-2 md:px-4 py-2">Unit Price</TableCell>
        ...
        <>
          ...
          <div className="w-[90%] sm:w-[85%] mx-auto">
            <button
              ...
              className="w-full border mt-2 border-blue-500 p-2 rounded-sm hover:bg-blue-500 text-blue-600 hover:text-white text-xs md:text-base"
            >
              Claim All
            </button>
          </div>
