...
//   // Function to handle variation selection and update the total cost
//   const setSelectedVariation = (variation: TSingleProduct["variations"][0]) => {
//     console.log("Selected Variation ID:", variation?._id);
//     setSelectedVariationId(variation.id); // Optionally, set this ID in the state.

//     // Calculate the price based on the selected variation
//     const variationPrice =
//       variation.price?.salePrice || variation.price?.regularPrice || 0;

//     // Update the total cost based on the selected variation
//     const updatedTotal = variationPrice * (quantity || 1);
//     setTotalCost(updatedTotal);
//     setTotalExpense(updatedTotal);
//   };
...
//             .filter((key) => key.toLowerCase() !== "color") // Remove "color" attribute if needed
//             .map((key) => (
//               <div className="mb-6" key={key}>
//                 <h3 className="text-md font-semibold">Select {key}:</h3>
//                 <div className="flex flex-wrap my-2">
...
//                           <div
//                             onClick={() =>
//                               setSelectedVariation(filteredVariation)
//                             }
