...
const ShopPage = async ({ searchParams }: ShopPageProps) => {
  ...
  // Add any additional query parameters (like filters) based on the searchParams
  const queryParams = new URLSearchParams(
    searchParams as Record<string, string>
  );

  // If there are any extra parameters (such as minPrice, maxPrice, category), they will automatically be appended.
