    ...
    <section className="mt-5">
      <div className="flex justify-center items-center">
        <div className="w-full md:h-[230px] bg-[#116b80] flex justify-center items-center">
          <div className="w-[80%] h-[80%] bg-[#1d96b4] my-5 flex flex-col justify-center items-center md:w-[80%] md:h-[80%] rounded-md">
            <div className="mx-4 my-3 py-8">
              <h3 className="text-[#FFFFFF] text-2xl md:text-3xl lg:text-4xl text-center font-semibold">
                রিপ্লেসমেন্ট এর পদ্ধতি --
              </h3>
              <p className="text-[#FFFFFF] text-sm md:text-lg lg:text-xl text-center font-semibold">
