...
const FeaturesOfProduct = () => {
  const features = [
    ...
    },
    {
      id: "02",
      title:
        "বারবার সুইচ টিপতে হবে না, সন্ধ্যা হলে অটোমেটিক জল্বে উঠবে এবং সকাল হলে লাইট অটোমেটিক বন্ধ হয়ে যাবে।",
    },
    {
      id: "03",
      title: " নরমাল লাইটের মত যেকোন হোল্ডারে ব্যবহার করা যায়।",
    },
    {
      id: "04",
      title:
        " লাইটের ভিতরে উন্নত্য মানের সেন্সর ব্যবহার করার কারণে সহজে নস্ট হয় না এবং অনেক দিন যাবত ব্যবহার করতে পারবেন।",
    },
  ...
  return (
    <section className="sm:mx-10 my-8">
      <div>
        <div className="w-80 md:w-96 py-4 rounded-full text-center bg-[#FFD700] mx-auto sm:px-5 mt-4 mb-14">
